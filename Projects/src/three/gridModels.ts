...
import { scene, camera, renderer, controls } from './sceneManager';
...
function loadModels() { 
    ...
    const pineTexture = textureLoad.load("models/tree/textures/Material.001_baseColor.png");
    loader.load("models/tree/scene.gltf", (gltf) => {
        pine = gltf.scene;
    ...
    const sheepTexture = textureLoad.load("models/cow/textures/material_baseColor.png"); //?묐え?몄뿉 臾몄젣?덉쓬??
    loader.load("models/cow/scene.gltf", (gltf) => {
        sheep = gltf.scene;
    ...
    const fenceTexture = textureLoad.load('models/pebbles/textures/Wood_diffuse.png') 
    ...
    const hayTexture = textureLoad.load('models/grass/textures/lambert1_baseColor.jpeg');
    const hayTexture2 = textureLoad.load('models/grass/textures/lambert2_baseColor.png');
    ...
    const rockTexture = textureLoad.load('models/pebbles/textures/Material.010_baseColor.png');
    loader.load("models/pebbles/scene.gltf", (gltf) => {
        rock = gltf.scene;
    ...
    const stonePathTexture = textureLoad.load('models/pebbles/textures');
    loader.load("models/pebbles/scene.gltf", (gltf) => { //?섏젙?꾩슂
